        ...
        return (
            <div className="wrapper" style={{ backgroundImage: 'url(' + bg +')' }}>
                ...
                <div className="card card--alert a--fade-up a--delay-1">
                    <div className="card__content card__content--full">
                        <p>Tavola is currently in beta [0.2]. If you find any issues or bugs it would be super helpful if you reported them to <a href="mailto:matt@xeno-design.com">matt@xeno-design.com</a>. Thanks!</p>
                    </div>
                </div>
